...
The goal of rpackage is to make regular expressions more exciting! It
...
pak::pak("sjbalagit/524_individual_assignment_1_r")
```
...
That’s exactly what `rpackage::str_split_one()` does.
